    ...
    if Comm.available():
        ...
        if count == 1 or recvng:
            ...
            if count == numLoops:
                ...
                #print(fin_array) # img_bytes == fin_array!!!!!!!
                #breakpoint()

                path = '/home/pi/geladeira_ia/comm_jpg/foto.jpg'

                imghdr.what(fin_array)
                #stream = io.BytesIO(fin_array)
                #print(stream)
                #img = Image.open(stream)
                #img = Image.frombytes('RGB', (800, 600), str(fin_array).encode(), decoder_name="JPEG")
                #img.save('/home/pi/geladeira_ia/comm_jpg/foto.jpg', "JPEG")
                #img.show()
